...
<script src="<c:url value='/resources/js/jquery-ui.datepicker-ko.js'/>"></script>
<script src="<c:url value='/resources/plugin/poshytip-1.2/src/jquery.poshytip.js'/>"></script>
<!-- ===== realGrid  start ===== -->
