...
nxTSPKIConfig.installPage            = "/toolkit/openWebInstall.jsp";
nxTSPKIConfig.installMessage         = "SCORE PKI for OpenWeb 프로그램이 설치 되어 있지 않거나, 이전 버전이 설치되어 있습니다. \n\n설치페이지로 이동하시겠습니까?";
nxTSPKIConfig.processingImageUrl     = "/resources/plugin/ktnet/images/openWeb/processing2.gif"


nxTSPKIConfig.options.siteName = "SK실트론 구매시스템";
...
nxTSPKIConfig.options.bannerUrl = "localhost/resources/images/ktnet/openweb/gpost.bmp";
